...
`github.com/deepmap/oapi-codegen/v2` to `github.com/CeskyPane/oapi-codegen/v2`.
...
```sh
# for the binary install
go install github.com/CeskyPane/oapi-codegen/v2/cmd/oapi-codegen@latest
```
...
import (
	_ "github.com/CeskyPane/oapi-codegen/v2/cmd/oapi-codegen"
)
```
...
```go
//go:generate go run github.com/CeskyPane/oapi-codegen/v2/cmd/oapi-codegen --config=config.yaml ../../api.yaml
```
...
$ go get github.com/CeskyPane/oapi-codegen/v2@main
# alternatively, to a commit hash i.e. https://github.com/deepmap/oapi-codegen/commit/71e916c59688a6379b5774dfe5904ec222b9a537
$ go get github.com/CeskyPane/oapi-codegen/v2@71e916c59688a6379b5774dfe5904ec222b9a537
```
...
+++ go.mod
@@ -2,21 +2,20 @@
-require github.com/CeskyPane/oapi-codegen/v2 v2.1.0
+require github.com/CeskyPane/oapi-codegen/v2 v2.1.1-0.20240331212514-80f0b978ef16
```
...
For full details of what is supported, it's worth checking out [the GoDoc for `codegen.Configuration`](https://pkg.go.dev/github.com/CeskyPane/oapi-codegen/v2/pkg/codegen#Configuration).
...
In this case, we will expose a [compatibility option](https://pkg.go.dev/github.com/CeskyPane/oapi-codegen/v2/pkg/codegen#CompatibilityOptions) to restore old behaviour.
...
import (
	...
	"github.com/CeskyPane/oapi-codegen/v2/examples/minimal-server/stdhttp/api"
)
...
import (
	...
	"github.com/CeskyPane/oapi-codegen/v2/examples/minimal-server/chi/api"
...
import (
	...
	"github.com/CeskyPane/oapi-codegen/v2/examples/minimal-server/gorillamux/api"
...
import (
	...
	"github.com/CeskyPane/oapi-codegen/v2/examples/minimal-server/echo/api"
	"github.com/labstack/echo/v4"
)
...
import (
	...
	"github.com/CeskyPane/oapi-codegen/v2/examples/minimal-server/fiber/api"
	"github.com/gofiber/fiber/v2"
)
...
import (
	...
	"github.com/CeskyPane/oapi-codegen/v2/examples/minimal-server/gin/api"
	"github.com/gin-gonic/gin"
)
...
import (
	...
	"github.com/CeskyPane/oapi-codegen/v2/examples/minimal-server/iris/api"
	"github.com/kataras/iris/v12"
)
...
//go:generate go run github.com/CeskyPane/oapi-codegen/v2/cmd/oapi-codegen -config cfg.yaml api.yaml
```
...
import (
	...
	"github.com/CeskyPane/oapi-codegen/v2/examples/client"
)
...
import-mapping:
  ...
  ../common/api.yaml: github.com/CeskyPane/oapi-codegen/v2/examples/import-mapping/common
```
...
import (
	// ...
	externalRef0 "github.com/CeskyPane/oapi-codegen/v2/examples/import-mapping/common"
)
...
import (
	...
	"github.com/CeskyPane/oapi-codegen/v2/pkg/securityprovider"
)
...
Notice that we're using a pre-built provider from the [`pkg/securityprovider` package](https://pkg.go.dev/github.com/CeskyPane/oapi-codegen/v2/pkg/securityprovider), which has some inbuilt support for other types of authentication, too.
...
Check [the docs](https://pkg.go.dev/github.com/CeskyPane/oapi-codegen/v2/pkg/codegen#OutputOptions) for more details of usage.
