...
import (
	...
	"github.com/CeskyPane/oapi-codegen/v2/examples/authenticated-api/stdhttp/api"
	"github.com/CeskyPane/oapi-codegen/v2/examples/authenticated-api/stdhttp/server"
)
